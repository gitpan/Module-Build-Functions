...
sub meta_merge {
	...
	if ((defined $ARGS{meta_merge}{$key}) and ( ref $value ne ref $ARGS{meta_merge}{$key} )) {
		confess 'Mismatch between value to merge into meta information and value already there';
	}
